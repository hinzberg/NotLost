...
extension Trail {
    ...
    static func getAllTrails() -> [Trail]
    {
        ...
        trails.append(contentsOf: [
            Trail(name: "Hometown", coordinates: [
                (51.499052661223395, 7.61587420796521), (51.498941755500326, 7.618324414303657), (51.49689241181979, 7.616560986478088)])
        ])
